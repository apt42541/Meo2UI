...
function VLib:Window(text, textgame, textcircle)
	...
	MainTitle.Position = UDim2.new(0.2, 0, 0.0512162149, 0)
	...
	GameTitle.Position = UDim2.new(0.2, 0, 0.0892162398, 6)
	...
	function Tabs:Tab(text)
		...
		local GradientTab = Instance.new("UIGradient")
		...
		function ContainerItems:Button(text, callback)
            ...
            ClickImage.Position = UDim2.new(0, 0368, 0, 7.8)
            ClickImage.Size = UDim2.new(0, 26, 0, 25)
		...
		function ContainerItems:Toggle(text, default,callback)
			...
			GradientToggle.Parent = ToggleFrameRainbow
			...
			ToggleDot.Position = UDim2.new(0.104999997, -3, 0.289000005, -3)
...
if default == true then
		...
		function ContainerItems:Slider(text, min, max, start, callback)
			...
			GradientSlider.Parent = SliderIndicator
		...
		function ContainerItems:Dropdown(text, list, callback)
			...
			DropdownHolder.ScrollBarThickness = 7
			DropdownHolder.CanvasSize = UDim2.new(0, 0, 0, 0)
			DropdownHolder.ScrollBarImageColor3 = Color3.fromRGB(255, 255, 255)
